...
var Chart = Backbone.View.extend({
    ...
    add_button: function() {
        var $chart_button = 
            $('<a href="#chart" class="chart button disabled_toolbar i18n" title="Toggle SaikuChartPlus"></a>')
            .css({  'background-image': "url('js/saiku/plugins/SaikuChartPlus/SaikuChartPlus.png')",
...
(function() {
    ...
    // Initialize CCC
    $.ajax({
        url: "js/saiku/plugins/SaikuChartPlus/ccc.js",
        dataType: "script",
        cache: true,
        success: function() {        	  		
